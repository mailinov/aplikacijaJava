...
public class AdresaController {
	...
	// -----------------------METODA GET - DOBIVANJE ADRESE PO
	// ID-------------------------------------
	...
	// -----------------------METODA POST - SPREMANJE
	// ADRESE-------------------------------------------

	@RequestMapping(value = "/saveAdresa", method = RequestMethod.POST)
	public int saveAdresa(@RequestBody Adresa novaAdresa) throws SQLException {

		try {
			int lastId = AdresaServis.save(novaAdresa);
			return lastId;
		} catch (Exception e) {
